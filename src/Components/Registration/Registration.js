    ...
    <>
      ...
      <div className="registration__bg flex items-center justify-center gap-14">
        ...
        >
          ...
          Forget Password?{" "}
            <Link className="text-[#0052cc] cursor-pointer font-semibold" to="/forgetpassword">
            Find Here
            </Link>
          </p>
          <button
